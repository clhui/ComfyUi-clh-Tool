...
class String2FatLabels(PreviewImage):
    ...
    def create_fat_label_with_cv2(self, text, font_size, font_path, prompt=None, extra_pnginfo=None):
        ...
        draw.text((x, y), text, fill=font_color, font=font, align=ImageDraw.ALIGN_LEFT, spacing=line_spacing)
    ...
    def calculate_text_size(self, text, font_size,line_spacing, font_path):
        ...
        left, top, right, bottom = draw.textbbox((0, 0), text, font, align=ImageDraw.ALIGN_LEFT, spacing=line_spacing)
